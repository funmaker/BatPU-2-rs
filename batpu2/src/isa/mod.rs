...
mod tests {
	...
	#[test]
	fn to_machine_code() {
		assert_eq!(Instruction::NOP                                     .as_u16(), 0x0000, "NOP");
		assert_eq!(Instruction::HLT                                     .as_u16(), 0x1000, "HLT");
		assert_eq!(Instruction::ADD{ a: 0x3,     b: 0x4,      c: 0x5   }.as_u16(), 0x2345, "ADD");
		assert_eq!(Instruction::SUB{ a: 0x9,     b: 0x3,      c: 0x9   }.as_u16(), 0x3939, "SUB");
		assert_eq!(Instruction::NOR{ a: 0xE,     b: 0xE,      c: 0xF   }.as_u16(), 0x4EEF, "NOR");
		assert_eq!(Instruction::AND{ a: 0x4,     b: 0x0,      c: 0x5   }.as_u16(), 0x5405, "AND");
		assert_eq!(Instruction::XOR{ a: 0x1,     b: 0x2,      c: 0x3   }.as_u16(), 0x6123, "XOR");
		assert_eq!(Instruction::RSH{ a: 0xA,                  c: 0xB   }.as_u16(), 0x7A0B, "RSH");
		assert_eq!(Instruction::LDI{ a: 0x9,                imm:-0x1   }.as_u16(), 0x89FF, "LDI");
		assert_eq!(Instruction::ADI{ a: 0x8,                imm: 0x42  }.as_u16(), 0x9842, "ADI");
		assert_eq!(Instruction::JMP{                       addr: 0x3FF }.as_u16(), 0xA3FF, "JMP");
		assert_eq!(Instruction::BRH{ cond: Cond::Zero,     addr: 0x222 }.as_u16(), 0xB222, "BRH");
		assert_eq!(Instruction::BRH{ cond: Cond::NotZero,  addr: 0x123 }.as_u16(), 0xB523, "BRH");
		assert_eq!(Instruction::BRH{ cond: Cond::Carry,    addr: 0x009 }.as_u16(), 0xB809, "BRH");
		assert_eq!(Instruction::BRH{ cond: Cond::NotCarry, addr: 0x3FF }.as_u16(), 0xBFFF, "BRH");
		assert_eq!(Instruction::CAL{                       addr: 0x137 }.as_u16(), 0xC137, "CAL");
		assert_eq!(Instruction::RET                                     .as_u16(), 0xD000, "RET");
		assert_eq!(Instruction::LOD{ a: 0x1,     b: 0x2, offset: 0x3   }.as_u16(), 0xE123, "LOD");
		assert_eq!(Instruction::STR{ a: 0xF,     b: 0xF, offset:-0x1   }.as_u16(), 0xFFFF, "STR");
	}
	...
	fn from_machine_code() {
		...
		assert_eq!(Instruction::LDI{ a: 0x9,                imm:-0x1   }, Instruction::from(0x89FF), "LDI");
